...
<body>
    ...
    <header>
      ...
      <a href="mapping.php">Maping</a>
      <a href="fetch.php">Maping details</a>
...
<br><br><br>
  <div class="rowtwo" id="teacher">
      ...
      <div class="form-group">
          ...
          <div class="col-sm-7">
            <input type="text" name="tc_id"  class="form-control" id="tc_id" placeholder="teacher's id" />
          </div>
      </div>
      ...
      <div class="form-group">
          <label for="input1" class="col-sm-3 control-label">Name</label>
          <div class="col-sm-7">
            <input type="text" name="tc_name"  class="form-control" id="tc_name" placeholder="teacher full name" />
          </div>
      </div>
      ...
      <div class="form-group">
          <label for="input1" class="col-sm-3 control-label">Department</label>
          <div class="col-sm-7">
            <input type="text" name="tc_dept"  class="form-control" id="tc_dept" placeholder="department ex. CSE" />
          </div>
      </div>
      ...
      <div class="form-group">
          <label for="input1" class="col-sm-3 control-label">Email</label>
          <div class="col-sm-7">
            <input type="email" name="tc_email"  class="form-control" id="tc_email" placeholder="valid email" />
          </div>
      </div>
      ...
      <div class="form-group">
          ...
          <div class="col-sm-7">
            <input type="text" name="tc_course"  class="form-control" id="tc_course" placeholder="subject ex. Software Engineering" />
          </div>
      </div>
