...
<html>
	...
	<body>
	<form method="post" action="resconn.php">
			<div id="semester1" class="show">
				<fieldset>
					...
					<table border="1" style="text-align: center;" class="center">
						...
						<tbody>
							<tr>
								<td><label for="s1_Marks">Marks</label></td>
			...
			<div id="semester2" class="show">
				<fieldset>
					...
					<table border="1" style="text-align: center;" class="center">
						...
						<tbody>
							<tr>
								<td><label for="s2_Marks">Marks</label></td>
			...
			<div id="semester3" class="show">
				<fieldset>
					...
					<table border="1" style="text-align: center;" class="center">
						...
						<tbody>
							<tr>
								<td><label for="s3_Marks">Marks</label></td>
			...
			<div id="semester4" class="show">
				<fieldset>
					...
					<table border="1" style="text-align: center;" class="center">
						...
						<tbody>
							<tr>
								<td><label for="s4_Marks">Marks</label></td>
			...
			<div id="semester5" class="show">
				<fieldset>
					...
					<table border="1" style="text-align: center;" class="center">
						...
						<tbody>
							<tr>
								<td><label for="s5_Marks">Marks</label></td>
			...
			<div id="semester6" class="show">
				<fieldset>
					...
					<table border="1" style="text-align: center;" class="center">
						...
						<tbody>
							<tr>
								<td><label for="s6_Marks">Marks</label></td>
			...
			<div id="semester7" class="show">
				<fieldset>
					...
					<table border="1" style="text-align: center;" class="center">
						...
						<tbody>
							<tr>
								<td><label for="s7_Marks">Marks</label></td>
			...
			<div id="semester8" class="show">
				<fieldset>
					...
					<table border="1" style="text-align: center;" class="center">
						...
						<tbody>
							<tr>
								<td><label for="s8_Marks">Marks</label></td>
